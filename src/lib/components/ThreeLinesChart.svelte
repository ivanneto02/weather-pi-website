...
<ChartAndSelector title="Temperature" let:selectedWindow>
...
<ChartAndSelector title="Humidity" let:selectedWindow>
	<div class="h-[250px] p-4 rounded bg-black" data-window={selectedWindow}>
		<Chart
			data={dataSeries}
			x={(d) => new Date(d.timestamp)}
...
<ChartAndSelector title="Pressure" let:selectedWindow>
	<div class="h-[250px] p-4 rounded bg-black" data-window={selectedWindow}>
		<Chart
			data={dataSeries}
			x={(d) => new Date(d.timestamp)}
